...
{ public:
 ...
 while(p<=100)
     {
  cout<<"\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\";
 cout<<"\n\n\t\t\tBENJAMIN'S' SCHOOL MANAGEMENT PROGRAM\n\n";
 cout<<"\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\";
 cout<<"\n\n\t\t\tMAIN SCREEN\n\n";    	
cout<<"1.Enter 1 for STUDENTS biodata.\n";
cout<<"2.Enter 2 for STAFF  biodata.\n";
cout<<"3.Enter 3 for EXIT program.\n";
cin>>intro;
if(intro=="1")
 {   while(stdMenu<=10)
     {system("color 50");
  ...
  cout<<"1.Add new students and assign courses.\n";
  cout<<"2.Edit both students and courses\n";
  cout<<"3.Delete students.\n";
  cout<<"4.Print academic record.\n";
  cout<<"PRESS ANY KEY TO JUMP TO THE MAIN SCREEN.\n";
  ...
  if(stdIntro=="1")
    ...
    if((k.sex[i-1])=="m"||(k.sex[i-1])=="M")
        ...
        k.sex[i-1]="FEMALE";
    cout<<"How many courses will "<<k.name[i-1]<<" be offering\n";
    cin>>cNo[i-1];
    cout<<"Enter the course codes and press enter after each output\n";
    for(r=0;r<cNo[i-1];r++)
      cin>>k.courses[r][i-1];
    ...
    cout<<"Information of "<<k.name[i-1]<<" stored and recorded successfully\n";
    ...
    cout<<"Enter another key to go back to the main menu";
    cin>>addStd;
    if(addStd=='p')
     {   system("cls");
         cout<<"                                              ACADEMIC RECORD FOR STUDENTS                                                     \n";
cout<<"Student ID number: "<<k.ID[i-1]<<"                                                                   DATE OF BIRTH: "<<k.dob[i-1]<<endl;
cout<<"                                                                                          Gender: "<<k.sex[i-1]<<endl;
...
cout<<"Academic year:2018/2019          1st semester                            CCT: 9     CCP: 9       CGPA:"<<fixed<<setprecision(1)<<GPA[i-1]<<"          \n";
cout<<"COURSE                                                                     CREDIT     GRADE        GPT                     \n";
for( r=0;r<cNo[i-1];r++)
cout<<k.courses[r][i-1]<<"                                                    \t            "<<k.credit[r][i-1]<<"  \t   "<<k.gpa[r][i-1]<<"  \t   "<<k.gpt[r][i-1]<<endl;
     cout<<"Press any key to return to student menu\n";
     cin>>stdToMain;
     system("cls");
     break;
     system("cls");
    ...
    { while(x<=10)
          { system("cls");
           cout<<"Enter the number of the student whose details you want to edit( e.g.enter 1 for student 1 )\n";
...
cout<<k.courses[r][print-1]<<"                                                    \t            "<<k.credit[r][print-1]<<"  \t   "<<k.gpa[r][print-1]<<"  \t   "<<k.gpt[r][print-1]<<endl;
    ...
    cin>>t.CNum[v0-1];
    cout<<"Enter the course codes after each course and  press the enter key\n";
    for(r=0;r<t.CNum[v0-1];r++)
      cin>>t.courses[r][v0-1];
        system("cls");
       cout<<"Data of "<<t.FName[v0-1]<<" stored successfully\n";
    cout<<"Wish to add another staff member or print "<<t.FName[v0-1]<<"'s details?\n";
    cout<<"Enter \'a\', for add or \'p\' for printing of details\n";
    cout<<"Press any other key to jump to the main menu\n";
    cin>>addStd;
    if(addStd=='p')
     {   system("cls");
     ...
     cout<<"Press any key to return to staff menu\n";
     cin>>stdToMain;
     break;
     system("cls");
     }
    ...
    for(r=0;r<t.CNum[i-1];r++)
      ...
      break;
          ...
          x++;
            ...
            { while(e<=10)
          { system("cls");
           cout<<"Enter the number of the student whose records you want to delete( e.g.enter 1 for student 1 )\n";
           cin>>del;
           t.FName[del-1]=" ";
           t.LName[del-1]=" ";
           t.ID[del-1]=" ";
